...
const TextParallaxContent = ({ imgUrl, heading, children }: { imgUrl: any, heading: string, children: React.ReactNode }) => {
  return (
    <div
      style={{
...
const ExampleContent1 = () => (
  <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-4 pb-24 pt-12 md:grid-cols-12">
    ...
    <div className="col-span-1 md:col-span-8">
      ...
      <button className="w-full rounded bg-neutral-900 px-9 py-4 text-4xl text-white transition-colors hover:bg-neutral-700 md:w-fit">
        Записаться <FiArrowUpRight className="inline" />
      </button>
    </div>
  </div>
);
